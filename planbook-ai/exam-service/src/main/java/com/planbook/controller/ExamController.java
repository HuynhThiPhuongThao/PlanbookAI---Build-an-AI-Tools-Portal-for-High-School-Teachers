...
public class ExamController {
    ...
    public ResponseEntity<ExamResponse> createExam(
        ...
        return ResponseEntity.ok(examService.createExam(request, principal.getUserId()));
    }
    ...
    public ResponseEntity<SubmissionResponse> submitExam(
        ...
        return ResponseEntity.ok(
                submissionService.submitExam(id, principal.getUserId(), studentName, image)
        );
    }
    ...
    public ResponseEntity<List<ResultResponse>> getResults(
            @PathVariable Long id,
            @AuthenticationPrincipal CustomUserPrincipal principal) {
        return ResponseEntity.ok(resultService.getResultsByExam(id, principal.getUserId()));
    }
}
