...
// – xử lý toàn bộ logic nghiệp vụ. Không đụng DB trực tiếp (nhờ Repository), không biết HTTP request là gì (Controller lo)
...
public class UserService {
    ...
    public UserResponse updateProfile(Long userId, UpdateProfileRequest request) {
        ...
        if (request.getSubjectSpecialty() != null) profile.setSubjectSpecialty(request.getSubjectSpecialty());
    ...
    public void deactivateUser(Long userId) {
        ...
        log.info("User {} deactivated", userId); // ghi log khoa tai khoan user
    }
    @Transactional
    public void activateUser(Long userId) {
        ...
        userProfileRepository.save(profile);
        log.info("User {} activated", userId); // ghi log mo tai khoan user
    }
    // === PRIVATE HELPER ===
