...
INSERT INTO prompts (name, type, content, version, is_active, approval_status, created_by, created_at, updated_at)
VALUES (
...
SELECT id, name, type, is_active, approval_status FROM prompts;
